...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["flour", "eggs", "sugar", "soy sauce"]
      ingredients.each do |ingredient|
        dessert.add_ingredient(ingredient)
      end
      expect(dessert.mix!).to_not eq (["flour", "eggs", "sugar", "soy sauce"])
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef Boyardee the Great Baker has made 3 cakes!")
    end
  end
